...
public class Bookings extends javax.swing.JDialog {
    
    public String PatientID;
    private String Field = "Appointments:";
    
    public Bookings(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        description_txtpn = new javax.swing.JTextPane();
        bookTitle_txtfld = new javax.swing.JTextField();
        schedule_txtfld = new javax.swing.JTextField();
        prescriptionTitleLabel1 = new javax.swing.JLabel();
        ...
        headerTitle1.setText("Book Appointment");
        ...
        medicationsLabel.setText("Description");
        ...
        prescriptionTitleLabel.setText("Book Title");
        ...
        addSchedbtn.setText("Schedule Book");
        ...
        description_txtpn.setBackground(new java.awt.Color(230, 230, 230));
        description_txtpn.setForeground(new java.awt.Color(0, 0, 0));
        jScrollPane4.setViewportView(description_txtpn);

        bookTitle_txtfld.setBackground(new java.awt.Color(230, 230, 230));
        bookTitle_txtfld.setForeground(new java.awt.Color(0, 0, 0));

        schedule_txtfld.setBackground(new java.awt.Color(230, 230, 230));
        schedule_txtfld.setForeground(new java.awt.Color(0, 0, 0));

        prescriptionTitleLabel1.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        prescriptionTitleLabel1.setForeground(new java.awt.Color(0, 0, 0));
        prescriptionTitleLabel1.setText("Schedule");

        appointmentLabel.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        appointmentLabel.setForeground(new java.awt.Color(0, 0, 0));
        appointmentLabel.setText("Book Detail");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(schedule_txtfld)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(prescriptionTitleLabel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 357, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(prescriptionTitleLabel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 357, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addGap(72, 72, 72))))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(bookTitle_txtfld, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(prescriptionTitleLabel1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(schedule_txtfld, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(12, 12, 12)
    ...
    public void ResetValues() {
        bookTitle_txtfld.setText("");
        schedule_txtfld.setText("");
        description_txtpn.setText("");
        repaint();
        revalidate();
    }
    ...
    private void addSchedbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addSchedbtnActionPerformed
        if (!(bookTitle_txtfld.getText().equals("") || schedule_txtfld.getText().equals("") || description_txtpn.getText().equals(""))) {
            String newValue = bookTitle_txtfld.getText() + "^" + schedule_txtfld.getText() + "^" + description_txtpn.getText();
            System.out.println(Integer.parseInt(PatientID));
    ...
    private javax.swing.JTextField bookTitle_txtfld;
    private javax.swing.JButton cancelbtn;
    private javax.swing.JTextPane description_txtpn;
    ...
    private javax.swing.JLabel prescriptionTitleLabel1;
    private javax.swing.JTextField schedule_txtfld;
