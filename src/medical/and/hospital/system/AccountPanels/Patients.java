...
public class Patients extends javax.swing.JPanel {
    ...
    public void refresh() {
        ...
        displayAccounts_Patients(contentPanel, PatientNames, jScrollPane1, fileHandling.patients, this);
            
        revalidate();
        repaint();
    }
    
    public void displayAccounts_Patients(JPanel contentPanel, ArrayList<String> DoctorNames, JScrollPane ScrollPane1, String accType, Patients ps) {
        ...
        for (int i = 0; i < DoctorNames.size(); i++) {
            ...
            ad.checkRecord_btn.addActionListener((e) -> {
                fileHandling.saveToReference(fileHandling.selectedPatientID, String.valueOf((ia+1)));
