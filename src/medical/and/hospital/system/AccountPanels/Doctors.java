...
public class Doctors extends javax.swing.JPanel {
    ...
    public void refresh() {
        ...
        DoctorNames.clear();
        fileHandling.extractNamesOnly(fileHandling.doctor, DoctorNames);
        initializer.displayAccounts(contentPanel, DoctorNames, jScrollPane1, fileHandling.doctor, this);
        repaint();
        revalidate();
    }
    ...
    private void addAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addAccountActionPerformed
        ...
        dialog.savebtn.addActionListener((e) -> {
            ...
            fileHandling.registerUser(fileHandling.doctor, WIDTH, name, password);
            dialog.dispose();
